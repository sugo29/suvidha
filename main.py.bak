...
@app.route('/<path:path>')
def catch_all(path):
    # Serve SeniorCitizen Dashboard files
    ...
    try:
        ...
        if 'dateOfBirth' in data:
            try:
                ...
                # Auto-determine if senior citizen (60+ years)
                today = date.today()
...
@app.route('/api/citizen/bills', methods=['GET'])
...
@app.route('/api/citizen/bills/<bill_id>', methods=['GET'])
...
@app.route('/api/citizen/bills/<bill_id>/pay', methods=['POST'])
...
@app.route('/api/citizen/bills/summary', methods=['GET'])
...
@app.route('/api/citizen/complaints/<complaint_id>', methods=['GET'])
...
@app.route('/api/citizen/complaints/summary', methods=['GET'])
...
@app.route('/api/senior/live-waste-service', methods=['GET'])
def get_live_waste_service():
    ...
    try:
        ...
        # Mock data for waste collection - in real app, this would come from actual service
        waste_service = {
            'next_collection': {
...
@app.route('/api/senior/updates', methods=['GET'])
def get_senior_updates():
    ...
    try:
        ...
        # Mock updates - in real app, fetch from database
        updates = [
            {
                'id': str(uuid.uuid4()),
...
@app.route('/api/citizen/community/stats', methods=['GET'])
def get_community_stats():
    ...
    try:
        ...
        # Get ward-level community stats
...
@app.route('/api/citizen/community/leaderboard', methods=['GET'])
...
@app.route('/api/citizen/consumption', methods=['GET'])
def get_consumption_data():
    ...
    try:
        ...
        # Get bills for the specified utility type
